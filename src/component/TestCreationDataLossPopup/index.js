...
const TestCreationDataLossPopup = (props) => {
    return (
        <div className="test-creation-data-loss-container-model">
            <div className="delete-skillset-type-box">
                ...
                <div className="content" style={{marginTop:"10px"}}>
                    ...
                    <div className="content-heading">
                        <span>Do You Want Exit From Assessment Creation Flow</span> 
                    </div>
                </div>
...
export default TestCreationDataLossPopup;