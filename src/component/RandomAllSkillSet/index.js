...
const RandomAllSkillSet = (props) => {
    ...
    const onClickAdd = () => {
        if (easyScore > 0 && mediumScore > 0 && hardScore > 0) {
            props.addData({ score: `Easy(${easyScore}),Medium(${mediumScore}),Hard(${hardScore})` })
    ...
    return (
        <div className="random-all-skillset-container">
            <div className="skillset-type-box">
                <div className="header">
                    <div className="title">
                        <span>Random All Skillset</span>
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={()=> props.closeButton({ score: `Easy(${easyScore}),Medium(${mediumScore},Hard(${hardScore}))`,random:false })} style={{ cursor: "pointer" }}>
                ...
                <div className="skill-table">
                    <table className="skillset" cellSpacing="0px">
                        ...
                        <tr>
                            ...
                            <td>
                                <input maxLength={3} value={easyScore} onChange={onChangeEasyScore} Wheel={(e) => e.target.blur()} onKeyDown={(evt) => (evt.key === 'e' || (evt.keyCode === 190 || evt.keyCode === 110)) && evt.preventDefault()} min={0} max={100} type="number" />
                        ...
                        <tr>
                            ...
                            <td>
                                <input maxLength={3} value={mediumScore} onChange={onChangeMediumScore} Wheel={(e) => e.target.blur()} onKeyDown={(evt) => (evt.key === 'e' || (evt.keyCode === 190 || evt.keyCode === 110)) && evt.preventDefault()} min={0} max={100} type="number" />
                ...
                <div className="button" style={{ marginTop: "5px" }}>
                    <div className="cancel-btn" onClick={()=>props.closeButton({ score: `Easy(${easyScore}),Medium(${mediumScore},Hard(${hardScore}))`,random:false })}>
...
export default RandomAllSkillSet