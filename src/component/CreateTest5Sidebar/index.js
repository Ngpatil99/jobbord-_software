            ...
            <div className="info-panel">
                ...
                <div className="info">
                    ...
                    <svg className='ver-line' width="2" height="65" viewBox="0 0 2 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="title">
                            <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20.6084 18.4521V19.7646H13.4307L13.376 18.7734L17.6689 12.0469H18.9883L17.5596 14.4941L15.0918 18.4521H20.6084ZM19.3643 12.0469V22H17.7168V12.0469H19.3643Z" fill="white" />
                                <circle cx="16.5" cy="16.5" r="16" stroke="white"  />
                            </svg>
                            <span >The Test</span>
                        </div>
...
export default CreateTest5Sidebar;