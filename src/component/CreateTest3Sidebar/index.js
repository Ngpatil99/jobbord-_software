...
function CreateTest3Sidebar() {
    return (
        <div className="CreateTest-3Sidebar">
                ...
                <div className="info">
                    ...
                    <svg className='ver-line' width="2" height="65" viewBox="0 0 2 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="title">
                            ...
                            <span style={{ opacity: "0.4" }}>The Test</span>
                        </div>
...
export default CreateTest3Sidebar;