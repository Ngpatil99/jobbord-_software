...
const ChangeJobRoleValue=(props)=> {
    return (
        <div className="change-job-role-container">
            <div className="delete-skillset-type-box">
                ...
                <div className="content">
                    <div className="icon">
                        <svg width="51" height="50" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M30.8346 19.5003V31.167C30.8346 31.609 30.659 32.0329 30.3465 32.3455C30.0339 32.6581 29.61 32.8337 29.168 32.8337H20.8346C20.3926 32.8337 19.9687 32.6581 19.6561 32.3455C19.3436 32.0329 19.168 31.609 19.168 31.167V19.5003M21.668 19.5003V17.8337C21.668 17.3916 21.8436 16.9677 22.1561 16.6551C22.4687 16.3426 22.8926 16.167 23.3346 16.167H26.668C27.11 16.167 27.5339 16.3426 27.8465 16.6551C28.159 16.9677 28.3346 17.3916 28.3346 17.8337V19.5003" fill="#FF6812" />
                            <path d="M30.8346 19.5003V31.167C30.8346 31.609 30.659 32.0329 30.3465 32.3455C30.0339 32.6581 29.61 32.8337 29.168 32.8337H20.8346C20.3926 32.8337 19.9687 32.6581 19.6561 32.3455C19.3436 32.0329 19.168 31.609 19.168 31.167V19.5003M21.668 19.5003V17.8337C21.668 17.3916 21.8436 16.9677 22.1561 16.6551C22.4687 16.3426 22.8926 16.167 23.3346 16.167H26.668C27.11 16.167 27.5339 16.3426 27.8465 16.6551C28.159 16.9677 28.3346 17.3916 28.3346 17.8337V19.5003" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M23.332 23.667V28.667" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M26.668 23.667V28.667" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                    <div className="content-heading">
                        <span>Do You Really Want To Change This Jobrole?</span>
                        {(props.questionNo!==null&&props.questionNo!==undefined)&&(props.sectionHeader!==null&&props.sectionHeader!==undefined)?
                        <p>Q.{props?.questionNo+1} - {props?.sectionHeader}</p>:<></>
                        }
                    </div>
                </div>
                ...
                <div className="button" style={{ marginTop: "5px" }}>
                    <div onClick={()=>props.cancelButton()} className="cancel-btn">
                    ...
                    <div onClick={()=>props.yesButton()} className="next-btn">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="9" cy="9" r="9" fill="white" />
...
export default ChangeJobRoleValue