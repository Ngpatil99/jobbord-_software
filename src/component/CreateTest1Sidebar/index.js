...
function CreateTest1Sidebar() {
    const navigate = useNavigate();

    return (
        <div className="CreateTest1Sidebar">
            <div className="info-panel">
                ...
                <div className="info">
                    <Link style={{ textDecoration: 'none' }} to="/newassessment" >
                        <div className="title">
...
export default CreateTest1Sidebar;