...
const InviteExpiredCandidate = (props) => {

    
    return (
        <div className="invite-expired-container-model">
            <div className="delete-skillset-type-box">
                ...
                <div className="content" style={{marginTop:"10px"}}>
                    ...
                    <div className="content-heading">
                       <p>Total {props.expiryCandidateCount} invites expired</p>
                       <p>Do You want To resend invitation?</p>
                    </div>
                </div>
...
export default InviteExpiredCandidate;