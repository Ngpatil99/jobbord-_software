...
function EditCandidateInvite(props) {
    return (
        <div className="edit-candidate-invite">
            <div className="edit-candidate-box">
                <div className="header">
                    <div className="title">
                        <span>Test Invite Edit</span>
                ...
                <div className="details">
                    ...
                    <div className="input-type">
                        ...
                        <div className="select-box">
                            <select name="" id="">
                                <option value="Textarea">1</option>
                                <option value="Textarea">2</option>
                                <option value="Textarea">3</option>
                                <option value="Textarea">4</option>
                                <option value="Textarea">5</option>
                            </select>
                ...
                <div className="button" style={{ marginTop: "5px" }}>
                    <div className="cancel-btn" onClick={() => { props.close() }}>
                    ...
                    <div className="next-btn" onClick={() => { props.close() }}>
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="9" cy="9" r="9" fill="white" />
...
export default EditCandidateInvite