...
import './QuestionPreviewSidebar.css';

function QuestionPreviewSidebar() {
    const navigate = useNavigate()
    return (
        <div className="question-preview-sidebar">
            <div className="info-panel">
                ...
                <div className="info">
                    <div onClick={()=>navigate('/newquestion')} className="title">
                    ...
                    <div onClick={()=>navigate('/createquestion')} className="title">
                        <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={()=>navigate('/questionpreview')} className="title">
                        <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
