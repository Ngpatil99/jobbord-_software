                ...
                <div className="mcq-bulk-upload-content">
                    ...
                    <div className="guideline-container" >
                        ...
                        <div className="button-container">
                            <div onClick={() => navigate('/assessmentOverview')} className="back">
                        ...
                        <div onClick={() => {navigate('/importedcandidate')}} style={{ cursor: 'pointer' }} className="upload-container" >
                            <input {...getInputProps()} />
                            {file === "" && !isDragActive ?
                                <>
                                ...
                                <>
                                    <label  >
                                        ...
                                        <span>{text}</span>
                                        <svg onClick={() => {navigate('/importedcandidate')}} style={{ cursor: 'pointer' }} width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {error ?
                                        <div onClick={() => {navigate('/importedcandidate')}} className="error-button" >
                                        ...
                                        :
                                        <div onClick={() => {navigate('/importedcandidate')}} className="upload-button" >
                                            {loading ?
                        ...
                        <div className="content">
                            ...
                            <p><b>Guidelines for Bulk Invitations</b><br />
                                <br />
                                <br />
                                1. Lorem ipsum dolor sit amet consectetur adipisicing..<br />
                                2. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos, temporibus?.<br />
                                3. Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur voluptates quia ipsum repellat!<br />
                            </p>
