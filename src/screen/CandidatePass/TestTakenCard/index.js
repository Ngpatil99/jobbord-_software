      ...
      <div className="first">
        <div className="header">
          ...
          {props.status !== "appeared" ? (
            ...
            <div
              className="status-move-to-review"
              onClick={(e) => {
                e.stopPropagation();
                props.moveToReview(props.candidate.invite._id);
            ...
            >
              ...
              >
                <path
                  d="M2.91406 7.0127H11.0807"
                  stroke="#00C49A"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M7 2.92969L11.0833 7.01302L7 11.0964"
                  stroke="#00C49A"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
          ...
          <div className="date-time">
            ...
            <span>
              ...
              {props.finishedDate !== undefined
                ? moment(props.finishedDate).format("DD-MMM-YYYY hh:mm A")
                : "-"}
            </span>
          </div>
        </div>
      ...
      <div className="fourth">
        {props.status !== "appeared" ? (
          <div className="candidate-current-status">
            ...
            >
              <path
                d="M14.8235 6.43846C14.797 6.32438 14.6849 6.25391 14.5728 6.28105C14.461 6.30833 14.392 6.42285 14.4188 6.53694C14.5282 7.00554 14.5838 7.5004 14.5838 8.00796C14.5838 11.6334 11.6304 14.5828 8 14.5828C4.36962 14.5828 1.41622 11.6334 1.41622 8.00796C1.41622 4.38228 4.36962 1.43265 8 1.43265C9.44584 1.43265 10.8269 1.89979 11.9939 2.7836C12.0859 2.85348 12.2165 2.83379 12.2849 2.73954C12.3534 2.6453 12.3341 2.51224 12.2418 2.44236C11.0027 1.5037 9.53585 1.00781 8 1.00781C4.14015 1.00781 1 4.14797 1 8.00796C1 11.8677 4.14015 15.0078 8 15.0078C11.8599 15.0078 15 11.8677 15 8.00796C15 7.46743 14.9406 6.93945 14.8235 6.43846Z"
                fill="black"
                stroke="black"
                stroke-width="1.25"
              />
              <path
                d="M7.71644 11.171C7.66238 11.171 7.61057 11.1486 7.5722 11.1088L3.74726 7.12468C3.66758 7.04167 3.66758 6.90716 3.74726 6.82414C3.82681 6.74113 3.95592 6.74113 4.03561 6.82414L7.7079 10.6493L14.6452 2.55435C14.7203 2.46681 14.8491 2.45923 14.9332 2.53743C15.0172 2.61562 15.0245 2.74984 14.9495 2.83738L7.86852 11.1001C7.83113 11.1437 7.7782 11.1694 7.72218 11.171C7.72022 11.171 7.7184 11.171 7.71644 11.171Z"
                fill="black"
                stroke="black"
                stroke-width="1.25"
              />
